...
st.set_page_config(layout="wide", page_title="The Climate Spectrum's Carbon Footprint Calculator")

# Streamlit app code
st.title("The Climate Spectrum's Carbon Footprint Calculator 👣")
